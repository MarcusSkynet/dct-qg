...
% Allows for planning future citations without generating output.
\makeatletter
\newcommand{\futurecite}[1]{\@gobble} % Change \@gobble to \cite{#1} to activate.
\makeatother
...
\newcommand{\br}{b_{\mathrm r}}        % The irreversible payload bit (legacy)
\newcommand{\W}{W}            % Payload/write bit (canon; replaces \br)
